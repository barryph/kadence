...
export default function StickyTable<TCell, TColumn, TRow>({
  ...
  //       const maxScrollX = Math.max(0, contentWidth - componentWidth.value);
  //       // scrollX.value = withSpring(-event.velocityX, { damping: 50 });
  ...
  //       const maxScrollY = Math.max(0, contentHeight - componentHeight.value);
  //       // scrollY.value = withSpring(-event.velocityY, { damping: 50 });
  ...
  // Derived value reacts to change and triggers scrollTo on the UI thread
  useDerivedValue(() => {
  ...
  // useDerivedValue(() => {
  //   console.log('scrolllll body')
  //   scrollTo(bodyRef, scrollX.value, scrollY.value, false);
  // });
