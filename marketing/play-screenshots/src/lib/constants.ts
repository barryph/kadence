...
/**
 * Kadence's deep-space palette, mirrored from the app's own tokens
 * (front-end/constants/theme.ts) so the store listing and the product agree.
 */
...
export const THEMES: Record<string, Theme> = {
  /**
   * Deep-space dark: near-black navy gradient with an electric blue to cyan
   * bloom. Kadence is dark-only, so this is the project's default.
   */
  "deep-space": {
    id: "deep-space",
    name: "Deep Space",
    bg: DEEP_SPACE.canvas,
    bgAlt: "#02030A",
    fg: DEEP_SPACE.textPrimary,
    fgAlt: DEEP_SPACE.textPrimary,
    accent: DEEP_SPACE.cyan,
    muted: DEEP_SPACE.textSubtle,
  },
  "clean-light": {
    id: "clean-light",
    name: "Clean Light",
